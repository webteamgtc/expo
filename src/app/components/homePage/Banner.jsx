            ...
            <section className="bg-white flex flex-col justify-center items-center py-4 relative  container mx-auto">
                ...
                <div className=" w-full flex justify-between items-center">
                    ...
                    <BookingCalendar
                        ...
                        customInputText=" Book Now"
                        customInputClass="bg-[#0d153a] px-5 py-2 rounded-full text-white text-sm font-medium shadow hover:bg-primary-dark transition"
                    />
                </div>
                ...
                <div className="w-full flex flex-col md:flex-row gap-3 py-10 items-center">
                    ...
                    <div className=' md:w-2/4 w-full'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 text-center text-sm">
                            <div>
                ...
                <div className='pb-20'>
                    <BookingCalendar
                        ...
                        onChange={setAppointmentDate}
                        label="Schedule Your Consultation"
                        customInputText=" Book a Meeting"
                        customInputClass="mt-6 bg-[#263f8f] text-white rounded-full px-6 py-3 font-medium hover:bg-primary-dark transition"
                    />
                </div>
            </section>
        </div>
