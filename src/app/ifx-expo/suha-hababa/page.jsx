...
import CalendlyButton from '@/app/components/homePage/CalendlyButton'
import Header from '@/app/components/Header'

const page = () => {
  return (
    <>
    <Header calendlyUrl="https://calendly.com/suha-hababa-gtcfx/ifx-expo-suha-hababa" />
    <section>
        <div className="bg-img-banner">
              <section className="bg-[#ffffffc7] flex flex-col justify-center items-center py-4 relative container mx-auto">
                ...
                <div className="w-full flex flex-col-reverse md:flex-row gap-6 md:py-10 items-center">
                  ...
                  <div className="text-center md:w-2/4 w-full px-4 hidden md:block">
                    ...
                    <div className="bg-[#263f8f] text-white rounded-tl-xl rounded-br-xl px-6 py-3 w-fit mx-auto text-sm font-medium shadow-md mt-2">
                      Suha Hababa <br />
                      <span className="text-xs">Business Development Director - Dubai</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="py-5 md:mb-8">
                  <CalendlyButton
                    url="https://calendly.com/suha-hababa-gtcfx/ifx-expo-suha-hababa"
                    text="Book a Meeting"
            ...
            <PartnerBanner calendlyUrl="https://calendly.com/suha-hababa-gtcfx/ifx-expo-suha-hababa" />
           <PartnerSectionTwo calendlyUrl="https://calendly.com/suha-hababa-gtcfx/ifx-expo-suha-hababa" />
            <GoodPartner calendlyUrl="https://calendly.com/suha-hababa-gtcfx/ifx-expo-suha-hababa" />
            <TalkTrendsSection calendlyUrl="https://calendly.com/suha-hababa-gtcfx/ifx-expo-suha-hababa" />
